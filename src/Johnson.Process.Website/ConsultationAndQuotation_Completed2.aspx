<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultationAndQuotation_Completed2.aspx.cs" Inherits="Johnson.Process.Website.ConsultationAndQuotation_Completed2" %>
    ...
    <div id="pnlProductsSalesTP">
        <div style="margin-top: 1em;">
            <table id="gridProductSalesTp" style="width:auto;height:auto" title="(第一部分) 非标报价">
		        <thead>
			        <tr>
				        <th field="productModel" resizable="false" width="100">产品型号</th>
