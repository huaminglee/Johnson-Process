<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultationAndQuotation_Start.aspx.cs" Inherits="Johnson.Process.Website.ConsultationAndQuotation_Start" %>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            $.post("ConsultationAndQuotationController.aspx?action=start", { taskId: taskId, formJson: objJson }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
