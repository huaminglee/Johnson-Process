<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultationAndQuotation_LOG.aspx.cs" Inherits="Johnson.Process.Website.ConsultationAndQuotation_LOG" %>
...
<body>
    <%--head --%>
    <johnson:Header runat="server" HeaderTitle="技术咨询及报价-物流部评审" ID="header"></johnson:Header>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            var logReply = $("#logForm").getFormValue().logReply;
            var submitRemark = $("#remarkForm").getFormValue().submitRemark;

            var args = {
                taskId: taskId, logReply: logReply, submitRemark: submitRemark
            };
            ...
            $.post("ConsultationAndQuotationController.aspx?action=logSubmit", { formJson: argsJson }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
