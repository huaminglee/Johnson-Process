<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderPingShen_SheJiEngineer.aspx.cs" Inherits="Johnson.Process.Website.OrderPingShen_SheJiEngineer" %>
...
<body>
    <%--head --%>
    <johnson:Header runat="server" HeaderTitle="订单评审-设计工程师" ID="header"></johnson:Header>
        ...
        <table class="formInfo">
            <tr>
                ...
                <td colspan="3" class="textCol">
                    <input  name="wanChengRiQi" type="text" class="textInput txtwidth required dateISO" />
                </td>
            </tr>
            <tr>
                <td class="labelCol" style="width: 200px">
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            $.post("OrderPingShenController.aspx?action=SheJiEngineerPingShenSubmit", { taskId: taskId, submitRemark: valueObj.submitRemark, wanChengRiQi: valueObj.wanChengRiQi, waiGouWanChengRiQi: valueObj.waiGouWanChengRiQi }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
