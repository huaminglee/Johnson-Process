<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VOC_CompletedSolutions.aspx.cs" Inherits="Johnson.Process.Website.VOC_CompletedSolutions" %>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            var args = $.getFormValue("#remarkForm, #solutionsForm");
            var d_solutionsCompleteTime = $.datepicker.parseDate("yy-mm-dd", args.solutionsCompleteTime);
            if(d_solutionsCompleteTime > new Date()){
                alert("完成时间不能大于今天！");
                return;
            }
            args.taskId = taskId;
            ...
            $.post("VocController.aspx?action=CompletedSolutionsSubmit", { formJson: argsJson }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
        ...
        $("#btnReturn").button().click(function () {
            ...
            $(this).attr("disabled", "disabled");
            $.post("VocController.aspx?action=CompletedSolutionsReturn", { formJson: argsJson }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
