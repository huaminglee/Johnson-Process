<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderWenjianFafang_Jiancha.aspx.cs" Inherits="Johnson.Process.Website.OrderWenjianFafang_Jiancha" %>
...
<body>
    <%--head --%>
    <johnson:Header runat="server" HeaderTitle="订单评审-技术检查" ID="header"></johnson:Header>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            $.post("OrderWenjianFafang_Controller.aspx?action=JiShuJianChaSubmit", { taskId: taskId, submitRemark: valueObj.submitRemark}, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
