<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FailureProduct_Storehouse.aspx.cs" Inherits="Johnson.Process.Website.FailureProduct_Storehouse" %>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            $.post("FailureProductController.aspx?action=StorehouseSubmit", { taskId: taskId, submitRemark: valueObj.submitRemark  }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
