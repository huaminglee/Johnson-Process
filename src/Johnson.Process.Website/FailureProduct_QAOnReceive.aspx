<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FailureProduct_QAOnReceive.aspx.cs" Inherits="Johnson.Process.Website.FailureProduct_QAOnReceive" %>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        $.get("FailureProductController.aspx?action=get", { taskId: taskId, r: Math.random() }, function (data) {
            ...
            $("#qaReceiveForm").setFormValue(data);
        ...
        $("#btnSubmit").button().click(function () {
            ...
            var valueObj = $.getFormValue("#remarkForm, #qaReceiveForm");
            $(this).attr("disabled", "disabled");
            $.post("FailureProductController.aspx?action=QAOnReceiveSubmit", { taskId: taskId, ReceiveQARemark: valueObj.ReceiveQARemark, submitRemark: valueObj.submitRemark }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
