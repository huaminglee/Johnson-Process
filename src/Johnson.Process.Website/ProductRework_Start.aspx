...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            $.post("ProductReworkController.aspx?action=start", { taskId: taskId, formJson: objJson, submitRemark: objJson.submitRemark, emailTo: valueObj.emailTo  }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
