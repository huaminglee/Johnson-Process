<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderPingShen_SCM.aspx.cs" Inherits="Johnson.Process.Website.OrderPingShen_SCM" %>
...
<body>
    <%--head --%>
    <johnson:Header runat="server" HeaderTitle="订单评审-SCM" ID="header"></johnson:Header>
        ...
        <table class="formInfo">
            <tr>
                ...
                <td colspan="3" class="textCol">
                    <input  name="wuLiaoDaoHuoRiQi" type="text" class="textInput txtwidth dateISO" />
                </td>
            </tr>
        </table>
    </form>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            $.post("OrderPingShenController.aspx?action=ScmPingShenSubmit", { taskId: taskId, submitRemark: valueObj.submitRemark, wuLiaoDaoHuoRiQi: valueObj.wuLiaoDaoHuoRiQi }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
