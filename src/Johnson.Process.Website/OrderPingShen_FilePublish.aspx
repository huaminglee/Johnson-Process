<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderPingShen_FilePublish.aspx.cs" Inherits="Johnson.Process.Website.OrderPingShen_FilePublish" %>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            $.post("OrderPingShenController.aspx?action=FilePublishSubmit", { taskId: taskId, submitRemark: valueObj.submitRemark}, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
