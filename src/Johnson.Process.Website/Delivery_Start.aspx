<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Delivery_Start.aspx.cs" Inherits="Johnson.Process.Website.Delivery_Start" %>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            $.post("DeliveryController.aspx?action=start", { taskId: taskId, delivery: objJson }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
