<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderPingShen_DianQiEngineer.aspx.cs" Inherits="Johnson.Process.Website.OrderPingShen_DianQiEngineer" %>
...
<body>
    <%--head --%>
    <johnson:Header runat="server" HeaderTitle="订单评审-电气工程师" ID="header"></johnson:Header>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            $.post("OrderPingShenController.aspx?action=DianQiPingShenSubmit", { taskId: taskId, submitRemark: valueObj.submitRemark, wanChengRiQi: valueObj.wanChengRiQi }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
