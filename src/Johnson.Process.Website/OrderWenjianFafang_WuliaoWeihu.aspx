<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderWenjianFafang_WuliaoWeihu.aspx.cs" Inherits="Johnson.Process.Website.OrderWenjianFafang_WuliaoWeihu" %>
...
<body>
    <%--head --%>
    <johnson:Header runat="server" HeaderTitle="订单评审-新物料信息维护" ID="header"></johnson:Header>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        $.get("OrderWenjianFafang_Controller.aspx?action=get", { taskId: taskId, r: Math.random() }, function (data) {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            $.post("OrderWenjianFafang_Controller.aspx?action=XinWuLiaoXinXiWeiHuSubmit", { taskId: taskId, submitRemark: valueObj.submitRemark}, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
