<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Voc_ResponsiblePrevious.aspx.cs" Inherits="Johnson.Process.Website.Voc_ResponsiblePrevious" %>
...
<body>
    <%--head --%>
    <johnson:Header runat="server" HeaderTitle="VOC-原因分析及纠正预防措施审核" ID="header"></johnson:Header>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            $.post("VocController.aspx?action=ResponsiblePreviousSubmit", { formJson: argsJson }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
        ...
        $("#btnReturn").button().click(function () {
            ...
            $(this).attr("disabled", "disabled");
            $.post("VocController.aspx?action=ResponsiblePreviousReturn", { formJson: argsJson }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
