<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderPingShen_Report.aspx.cs" Inherits="Johnson.Process.Website.OrderPingShen_Report" %>
...
<script language="javascript" type="text/javascript">
    ...
    function actionRender(takId, row){
        var processLink = "/EDoc2v4/Workflow/Common/UltimusWfTxStatus.aspx?pIncidentNo="+row.incidentNo+"&pProcessName="+encodeURIComponent("订单评审")+"&taskid=" + takId;
