<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderPingShen_CID.aspx.cs" Inherits="Johnson.Process.Website.OrderPingShen_CID" %>
...
<body>
    <%--head --%>
    <johnson:Header runat="server" HeaderTitle="订单评审-CID确认" ID="header"></johnson:Header>
    ...
    <div style="margin-top: 1em;">
        <table id="cidZiLiao" style="width:900px;height:auto" title="CID资料">
		    <thead>
			    <tr> 
				    <th field="FileName" resizable="false" width="200">文件名称</th>
                    <th field="FileId" resizable="false" formatter="fileActionFormater" width="100">操作</th>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            var cidZiLiao = $('#cidZiLiao').datagrid('getData');
            var valueObj = $.getFormValue("#remarkForm");
            valueObj.cidZiLiao = cidZiLiao.rows;
            ...
            $.post("OrderPingShenController.aspx?action=CidSubmit", { formJson: objJson }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
