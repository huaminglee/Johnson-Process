<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultationAndQuotation_SCM.aspx.cs" Inherits="Johnson.Process.Website.ConsultationAndQuotation_SCM" %>
...
<body>
    <%--head --%>
    <johnson:Header runat="server" HeaderTitle="技术咨询及报价-采购部评审" ID="header"></johnson:Header>
        ...
        <table class="formInfo">
            <tr >
                ...
                <td class="textCol" colspan="3" >
                    <textarea name="scmReply" class="textInput required" style="width: 500px;" rows="3"></textarea>
                </td>
            </tr>
        </table>
    </form>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            var scmReply = $("#scmForm").getFormValue().scmReply;
            var submitRemark = $("#remarkForm").getFormValue().submitRemark;

            var args = {
                taskId: taskId, scmReply: scmReply, submitRemark: submitRemark
            };
            ...
            $.post("ConsultationAndQuotationController.aspx?action=scmSubmit", { formJson: argsJson }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
