<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderPingShen_QAD.aspx.cs" Inherits="Johnson.Process.Website.OrderPingShen_QAD" %>
...
<body>
    <%--head --%>
    <johnson:Header runat="server" HeaderTitle="订单评审-QAD确认" ID="header"></johnson:Header>
    ...
    <div style="margin-top: 1em;">
        <table id="qadZiLiao" style="width:900px;height:auto" title="QAD资料">
		    <thead>
			    <tr> 
				    <th field="FileName" resizable="false" width="200">文件名称</th>
                    <th field="FileId" resizable="false" formatter="fileActionFormater" width="100">操作</th>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            var qadZiLiao = $('#qadZiLiao').datagrid('getData');
            var valueObj = $.getFormValue("#remarkForm");
            valueObj.qadZiLiao = qadZiLiao.rows;
            ...
            $.post("OrderPingShenController.aspx?action=QadSubmit", { formJson: objJson }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
