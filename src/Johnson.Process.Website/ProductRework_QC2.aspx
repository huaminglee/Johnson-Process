<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductRework_QC2.aspx.cs" Inherits="Johnson.Process.Website.ProductRework_QC2" %>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            var valueObj = $("#remarkForm, #qcForm").getFormValue();
            if (!confirm("您确实要提交吗？")) {
                return;
            }
            $(this).attr("disabled", "disabled");
            var formJson = $.toJSON(valueObj);
            $.post("ProductReworkController.aspx?action=QC2Submit", { taskId: taskId, formJson: formJson }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
