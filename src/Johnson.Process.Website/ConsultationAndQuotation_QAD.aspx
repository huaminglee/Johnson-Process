<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultationAndQuotation_QAD.aspx.cs" Inherits="Johnson.Process.Website.ConsultationAndQuotation_QAD" %>
...
<body>
    <%--head --%>
    <johnson:Header runat="server" HeaderTitle="技术咨询及报价-QAD评审" ID="header"></johnson:Header>
        ...
        <table class="formInfo">
            <tr >
                ...
                <td class="textCol" colspan="3" >
                    <textarea name="qadReply" class="textInput required" style="width: 500px;" rows="3"></textarea>
                </td>
            </tr>
        </table>
    </form>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            var qadReply = $("#qadForm").getFormValue().qadReply;
            var submitRemark = $("#remarkForm").getFormValue().submitRemark;

            var args = {
                taskId: taskId, qadReply: qadReply, submitRemark: submitRemark
            };
            ...
            $.post("ConsultationAndQuotationController.aspx?action=qadSubmit", { formJson: argsJson }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
