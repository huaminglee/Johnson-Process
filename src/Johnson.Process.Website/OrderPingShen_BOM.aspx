<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderPingShen_BOM.aspx.cs" Inherits="Johnson.Process.Website.OrderPingShen_BOM" %>
...
<body>
    <%--head --%>
    <johnson:Header runat="server" HeaderTitle="订单评审-BOM" ID="header"></johnson:Header>
        ...
        <table class="formInfo">
            <tr>
                ...
                <td colspan="3" class="textCol">
                    <input  name="shouCiWanChengRiQi" type="text" class="textInput txtwidth dateISO" />
                </td>
            </tr>
            <tr>
                <td class="labelCol" style="width: 200px">
                    整机BOM完成日期<span style="color: Red" >*</span>
                </td>
                <td colspan="3" class="textCol">
                    <input  name="zhengJiWanChengRiQi" type="text" class="textInput txtwidth required dateISO" />
                </td>
            </tr>
        </table>
    </form>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            $.post("OrderPingShenController.aspx?action=BOMPingShenSubmit", { taskId: taskId, submitRemark: valueObj.submitRemark, shouCiWanChengRiQi: valueObj.shouCiWanChengRiQi, zhengJiWanChengRiQi: valueObj.zhengJiWanChengRiQi }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
