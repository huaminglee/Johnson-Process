<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FailureProduct_MRB.aspx.cs" Inherits="Johnson.Process.Website.FailureProduct_MRB" %>
...
<body>
    <%--head --%>
    <johnson:Header runat="server" HeaderTitle="不合格品处理单-MRB" ID="header"></johnson:Header>
    ...
    <form id="mrbForm">
        ...
        <div>
            ...
            <input name="MrbResult" type="radio" value="3" /><label>返工/返修</label>
            <input name="MrbResult" type="radio" value="4" /><label>报废</label>
            <input name="MrbResult" type="radio" value="5" /><label>挑选</label>
        </div>
    </form>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            $.post("FailureProductController.aspx?action=MrbSubmit", { taskId: taskId, formJson: objJson }, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
