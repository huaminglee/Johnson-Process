<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderPingShen_Faqiren.aspx.cs" Inherits="Johnson.Process.Website.OrderPingShen_Faqiren" %>
...
<body>
    <%--head --%>
    <johnson:Header runat="server" HeaderTitle="订单评审-发起人确认" ID="header"></johnson:Header>
    ...
    <form id="basicInfoForm">
        ...
        <table class="formInfo">
            ...
            <tr>
                ...
                <td class="textCol">
                    <input  name="jiZuWanGongRiQi" type="text" class="textInput txtwidth " />
                </td>
            </tr>
        </table>
    </form>
...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        $("#btnSubmit").button().click(function () {
            ...
            $.post("OrderPingShenController.aspx?action=FaqirenQuerenSubmit", { taskId: taskId, submitRemark: valueObj.submitRemark, jiZuWanGongRiQi: valueObj.jiZuWanGongRiQi}, function (data) {
                if (data.result != 0) {
                    alert(data.message);
                }
                else {
